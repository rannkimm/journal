...
function App() {
  ...
  useEffect (() => {
    ...
    async function getEntries() {
      try {
        let res = await axios.get(`https://data.mongodb-api.com/app/data-tyfdb/endpoint/data/beta/entry`)
        setEntries(res.data)
      } catch (error) {
        console.log(error)
      }
    ...
    async function getAllUsers() {
      try {
      let response = await axios.get(`https://data.mongodb-api.com/app/data-tyfdb/endpoint/data/beta/user`)
  ...
  const addNewUser = async (e) => {
    ...
    const createUser = {
     ...
     if(currentUsersList.find(user => user.username === createUser.username) === undefined && createUser.password === createUser.confirmPassword) {
        let res = await axios.post(`https://data.mongodb-api.com/app/data-tyfdb/endpoint/data/beta/user/signin`, createUser)
  ...
  const getExistUser = async (e) => {
    ...
    if(currentUsersList.find(users => users.username === existUser.username) === undefined || currentUsersList.find(users => users.password === existUser.password) === undefined) {
      ...
      setLoginUser({username:'', password:''})
        ...
        let res = await axios({
          url: `https://data.mongodb-api.com/app/data-tyfdb/endpoint/data/beta/user/login/${existUser.username}/${existUser.password}`,
          method: 'get',
  ...
  const getUserEntries = async (e) => {
    try {
      ...
      let res = await axios({
        url: `https://data.mongodb-api.com/app/data-tyfdb/endpoint/data/beta/entry/${currentUser._id}`,
        method: 'get',
  ...
  const addNewUserEntry = async (e) => {
    ...
    let res = await axios.post(`https://data.mongodb-api.com/app/data-tyfdb/endpoint/data/beta/entry/new`, createEntry)
  ...
  const updateUserEntry = async () => {
    ...
    let updatedEntry = await axios({
      url: `https://data.mongodb-api.com/app/data-tyfdb/endpoint/data/beta/entry/${updateEntry._id}/update`,
      method: 'put',
      data: updateEntry
    })
  ...
  const deleteEntry = async () => {
    ...
    let deletedEntry = await axios({
      url: `https://data.mongodb-api.com/app/data-tyfdb/endpoint/data/beta/entry/${toDelete._id}`,
      method: 'delete',
      data: toDelete
    })
